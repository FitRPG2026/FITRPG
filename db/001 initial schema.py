...
# ══════════════════════════════════════════════════════════════════════════
# alembic/env.py  –  paste this into your env.py after running `alembic init`
# ══════════════════════════════════════════════════════════════════════════
ENV_PY_SNIPPET = '''
import os
...
# Inject NEON_URL from environment so it never lives in alembic.ini
config.set_main_option("sqlalchemy.url", os.environ["NEON_URL"])

if config.config_file_name is not None:
    fileConfig(config.config_file_name)

target_metadata = None  # swap for your Base.metadata if using ORM models
